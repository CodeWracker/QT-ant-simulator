...
""));
        ...
        config_3 = new QLabel(layoutWidget2);
        config_3->setObjectName(QString::fromUtf8("config_3"));
        config_3->setMinimumSize(QSize(230, 0));
        QFont font;
        font.setFamily(QString::fromUtf8("Audiowide"));
        font.setPointSize(12);
        config_3->setFont(font);
        config_3->setStyleSheet(QString::fromUtf8("QLabel#config_3{\n"
" color: white;\n"
"}"));

        horizontalLayout_4->addWidget(config_3);

        pathLife = new QLabel(layoutWidget2);
        pathLife->setObjectName(QString::fromUtf8("pathLife"));
        pathLife->setMinimumSize(QSize(30, 0));
        pathLife->setMaximumSize(QSize(30, 16777215));
        QFont font1;
        font1.setFamily(QString::fromUtf8("Audiowide"));
        font1.setPointSize(8);
        pathLife->setFont(font1);
        pathLife->setStyleSheet(QString::fromUtf8("QLabel#pathLife{\n"
" color: white;\n"
"}"));

        horizontalLayout_4->addWidget(pathLife);

        pathSlider = new QSlider(layoutWidget2);
        pathSlider->setObjectName(QString::fromUtf8("pathSlider"));
        pathSlider->setMinimum(1);
        pathSlider->setMaximum(500);
        pathSlider->setOrientation(Qt::Horizontal);

        horizontalLayout_4->addWidget(pathSlider);
...
"}"));
        ...
        antsNumber->setMinimumSize(QSize(30, 0));
        antsNumber->setMaximumSize(QSize(30, 16777215));
        QFont font2;
        font2.setFamily(QString::fromUtf8("Audiowide"));
        antsNumber->setFont(font2);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        config_3->setText(QApplication::translate("MainWindow", "Path Life (Steps)", nullptr));
        pathLife->setText(QApplication::translate("MainWindow", "100", nullptr));
